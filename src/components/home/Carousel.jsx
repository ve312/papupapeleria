  ...
  return (
    <div className="relative h-96 overflow-hidden">
      {slides.map((slide, index) => (
        ...
        >
          <div
            className={`h-full bg-gradient-to-r ${slide.bg} flex items-center justify-center relative overflow-hidden`}
          >
            <img
              src={slide.image}
              alt={slide.title}
            ...
            <div className="text-center z-10 px-4 max-w-4xl">
              <h2 className="text-6xl md:text-7xl font-extrabold text-white mb-4 drop-shadow-2xl animate-pulse">
                {slide.title}
              </h2>
              <p className="text-2xl md:text-3xl text-white mb-8 drop-shadow-lg font-semibold">
                {slide.subtitle}
              </p>
